    ...
    <div className="relative w-full overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        <motion.div 
          ...
          className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-blue-500/30 dark:bg-blue-400/5 rounded-full blur-[120px]"
        />
        <motion.div 
          animate={{ x: [0, -80, 0], y: [0, 100, 0], scale: [1, 1.1, 1] }}
          transition={{ duration: 25, repeat: Infinity, ease: "linear" }}
          className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-purple-500/30 dark:bg-purple-400/5 rounded-full blur-[120px]"
        />
      </div>
